...
const InstructorLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-indigo-500 to-pink-500 flex items-center justify-center p-4">
      {/* Main Container */}
      <div className="relative w-full max-w-4xl bg-white shadow-2xl rounded-2xl overflow-hidden flex h-[650px]">
        {/* Start From Here */}
        {/* Left Side - Swaps between overlay and form */}
        <div
          className={`w-1/2 p-8 transition-all duration-700 ease-in-out ${
            isSignUpActive
              ? "bg-white"
