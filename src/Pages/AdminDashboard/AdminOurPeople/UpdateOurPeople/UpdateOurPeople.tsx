...
import { useUpdateOurPeopleMutation } from "../../../../redux/api/features/OurPeople/ourPeopleManagementApi";

interface IProps {
  data: TOurPeople;
}

const UpdateOurPeople = ({ data }: IProps) => {
  ...
  console.log("Our People for update: ", data);

  const [updatePeople] = useUpdateOurPeopleMutation();
  ...
  return (
    <div className="">
      <div onClick={showModal}>
        <button
          className="p-2 bg-white/90 backdrop-blur-sm rounded-lg shadow-md hover:bg-blue-50 text-blue-600 transition-colors"
          aria-label="Edit"
        >
          <svg
      ...
      >
        <div className="">
          <h1 className="font-bold text-xl">Update Our people</h1>
          <form
          ...
          >
            ...
            <div className="flex justify-end space-x-4 pt-6">
              ...
              >
                <span className="relative z-10">Update Team Member</span>
...
export default UpdateOurPeople;
