          ...
          <div className="p-8 md:p-10 text-center  h-[450px]">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 px-6 py-4 rounded-xl bg-gradient-to-r from-[#25D366] to-[#1DA851] text-white font-semibold shadow-md hover:shadow-lg transition-all duration-200 hover:brightness-105 transform hover:-translate-y-0.5"
              >
                {/* WhatsApp icon */}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <button
                onClick={handleCopy}
                className="inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-white text-gray-800 font-semibold shadow border border-gray-300 hover:border-gray-400 transition-all duration-200 hover:shadow-md transform hover:-translate-y-0.5"
